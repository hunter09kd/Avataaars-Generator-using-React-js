...
export default function AvatarGenerator() {
    ...
    return (
        <div
            className="w-full max-w-md rounded-2xl shadow-xl backdrop-blur-xl border border-slate-70 p-4 md:p-10 flex flex-col items-center gap-8 animate__animated animate__slideInUp animate__faster">
            ...
            <div className="w-full space-y-4">
                ...
                <div
                    className="w-full bg-slate-900/60 text-white rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-slate-500 break-words break-all">
                    {state.imageUrl}
                </div>
            </div>
